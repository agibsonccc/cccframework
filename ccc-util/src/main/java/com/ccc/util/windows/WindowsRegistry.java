...
/**
 * Allows access to the Microsoft Windows registry using reflection.
 * 
 * Original source http://stackoverflow.com/questions/62289/read-write-to-windows-registry-using-java
 */
public class WindowsRegistry
{
	...
	private WindowsRegistry() { /** Do nothing. */ }
    ...
    */
	public static void createKey( int hkey, String key ) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException 
	{
		...
		else { throw new IllegalArgumentException( "hkey = " + hkey ); } //$NON-NLS-1$
