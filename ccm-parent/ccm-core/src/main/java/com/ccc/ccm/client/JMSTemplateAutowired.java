...
public class JMSTemplateAutowired extends JmsDestinationAccessor implements JmsOperations {
	    ...
	    private static Logger logger=LoggerFactory.getLogger(JMSTemplateAutowired.class);
	     ...
	     */
	    public JMSTemplateAutowired(ConnectionFactory connectionFactory) {
	        this();
