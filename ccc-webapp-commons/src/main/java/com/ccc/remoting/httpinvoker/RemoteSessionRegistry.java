...
public interface RemoteSessionRegistry extends Remote {
     ...
     */
    List<Object> getAllPrincipals() throws RemoteException;
     ...
     */
    List<SessionInformation> getAllSessions(Object principal, boolean includeExpiredSessions) throws RemoteException;
     ...
     */
    SessionInformation getSessionInformation(String sessionId) throws RemoteException;
     ...
     */
    void refreshLastRequest(String sessionId) throws RemoteException;
     ...
     */
    void registerNewSession(String sessionId, Object principal) throws RemoteException;
     ...
     */
    void removeSessionInformation(String sessionId) throws RemoteException;
}
