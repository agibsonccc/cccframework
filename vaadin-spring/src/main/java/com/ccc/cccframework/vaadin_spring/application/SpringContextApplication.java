 ...
 *
 * $Id: SpringContextApplication.java 251 2012-01-26 18:40:08Z archie.cobbs $
 */
...
public abstract class SpringContextApplication extends ContextApplication {
	...
	private void loadContext() {
		...
		// Logging
		log.info("loading application context for Vaadin application " + this.getApplicationName());
	...
	private class ContextCloseListener implements CloseListener, Serializable {
		...
		public void applicationClosed(CloseEvent closeEvent) {
			log.info("closing application context associated with Vaadin application "
	...
	private static Logger log=LoggerFactory.getLogger(SpringContextApplication.class);
}
